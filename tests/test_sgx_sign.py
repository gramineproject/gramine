...
from graminelibos.sgx_sign import (_cryptography_backend, sign_with_private_key_from_pem_path)
...
def test_sign_from_pem_path():
    ...
    exponent, modulus, signature = sign_with_private_key_from_pem_path(data, key_file)
...
def test_sign_from_pem_path_with_passphrase():
    ...
    exponent, modulus, signature = sign_with_private_key_from_pem_path(data, key_file, passphrase)
