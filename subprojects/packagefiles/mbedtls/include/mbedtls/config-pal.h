...
/* This mbedTLS config is for v3.6.2 and assumes Intel x86-64 CPU with AESNI and SSE2 support */

#pragma once

/* mbedTLS v3.6.2 by default enables the following TLS 1.3 features:
 *
