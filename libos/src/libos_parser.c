...
struct parser_table {
    ...
    [__NR_sigaltstack] = {.slow = false, .name = "sigaltstack", .parser = {parse_long_arg,
                          parse_pointer_arg, parse_pointer_arg}},
    [__NR_utime] = {.slow = false, .name = "utime", .parser = {parse_long_arg, parse_string_arg,
                    parse_pointer_arg}},
    ...
    [__NR_utimes] = {.slow = false, .name = "utimes", .parser = {parse_long_arg, parse_string_arg,
                     parse_pointer_arg}},
#ifdef __NR_vserver
    ...
    [__NR_utimensat] = {.slow = false, .name = "utimensat", .parser = {parse_long_arg,
                          parse_integer_arg, parse_string_arg, parse_pointer_arg,
                          parse_integer_arg}},
