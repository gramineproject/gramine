...
int main(int argc, char** argv) {
    ...
    int fd = CHECK(socket(PF_INET, SOCK_STREAM, 0));
    ...
    CHECK(getsockopt(fd, SOL_TCP, TCP_NODELAY, (void*)&so_flags, &optlen));
    ...
    CHECK(getsockopt(fd, IPPROTO_TCP, TCP_KEEPIDLE, (void*)&tcp_keepidle, &optlen));
    ...
    CHECK(getsockopt(fd, IPPROTO_TCP, TCP_KEEPINTVL, (void*)&tcp_keepintvl, &optlen));
    ...
    CHECK(getsockopt(fd, IPPROTO_TCP, TCP_KEEPCNT, (void*)&tcp_keepcnt, &optlen));
