...
static long sgx_exitless_ocall(uint64_t code, void* ocall_args) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&req->ocall_index, code);
    COPY_TO_UNTRUSTED_VALUE(&req->buffer, ocall_args);
    ...
    if (!locked) {
        ...
        if (!spinlock_cmpxchg(&req->lock, &c, SPINLOCK_LOCKED_NO_WAITERS)) {
            ...
            COPY_TO_UNTRUSTED_VALUE(&ocall_futex_args->futex, &req->lock.lock);
            COPY_TO_UNTRUSTED_VALUE(&ocall_futex_args->op, FUTEX_WAIT_PRIVATE);
            COPY_TO_UNTRUSTED_VALUE(&ocall_futex_args->timeout_us, (uint64_t)-1); /* never time out */
            ...
            do {
                ...
                if (c == SPINLOCK_LOCKED_WITH_WAITERS || /* shortcut: don't need to move lock state */
                     ...
                     * immediately returns */
                    COPY_TO_UNTRUSTED_VALUE(&ocall_futex_args->val, SPINLOCK_LOCKED_WITH_WAITERS);
...
noreturn void ocall_exit(int exitcode, int is_exitgroup) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_exit_args->exitcode, exitcode);
    COPY_TO_UNTRUSTED_VALUE(&ocall_exit_args->is_exitgroup, is_exitgroup);
...
int ocall_mmap_untrusted(void** addrptr, size_t size, int prot, int flags, int fd, off_t offset) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_mmap_args->addr, requested_addr);
    COPY_TO_UNTRUSTED_VALUE(&ocall_mmap_args->size, size);
    COPY_TO_UNTRUSTED_VALUE(&ocall_mmap_args->prot, prot);
    COPY_TO_UNTRUSTED_VALUE(&ocall_mmap_args->flags, flags);
    COPY_TO_UNTRUSTED_VALUE(&ocall_mmap_args->fd, fd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_mmap_args->offset, offset);
...
int ocall_munmap_untrusted(const void* addr, size_t size) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_munmap_args->addr, addr);
    COPY_TO_UNTRUSTED_VALUE(&ocall_munmap_args->size, size);
...
int ocall_cpuid(unsigned int leaf, unsigned int subleaf, unsigned int values[static 4]) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_cpuid_args->leaf, leaf);
    COPY_TO_UNTRUSTED_VALUE(&ocall_cpuid_args->subleaf, subleaf);
...
int ocall_open(const char* pathname, int flags, unsigned short mode) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_open_args->flags, flags);
    COPY_TO_UNTRUSTED_VALUE(&ocall_open_args->mode, mode);
    void* untrusted_pathname = sgx_copy_to_ustack(pathname, path_size);
    if (!untrusted_pathname) {
        sgx_reset_ustack(old_ustack);
        return -EPERM;
    }
    COPY_TO_UNTRUSTED_VALUE(&ocall_open_args->pathname, untrusted_pathname);
...
int ocall_close(int fd) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_close_args->fd, fd);
...
ssize_t ocall_read(int fd, void* buf, size_t count) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_read_args->fd, fd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_read_args->count, count);
    COPY_TO_UNTRUSTED_VALUE(&ocall_read_args->buf, untrusted_buf);
...
ssize_t ocall_write(int fd, const void* buf, size_t count) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_write_args->fd, fd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_write_args->count, count);
    COPY_TO_UNTRUSTED_VALUE(&ocall_write_args->buf, untrusted_buf);
...
ssize_t ocall_pread(int fd, void* buf, size_t count, off_t offset) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_pread_args->fd, fd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_pread_args->count, count);
    COPY_TO_UNTRUSTED_VALUE(&ocall_pread_args->offset, offset);
    COPY_TO_UNTRUSTED_VALUE(&ocall_pread_args->buf, untrusted_buf);
...
ssize_t ocall_pwrite(int fd, const void* buf, size_t count, off_t offset) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_pwrite_args->fd, fd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_pwrite_args->count, count);
    COPY_TO_UNTRUSTED_VALUE(&ocall_pwrite_args->offset, offset);
    COPY_TO_UNTRUSTED_VALUE(&ocall_pwrite_args->buf, untrusted_buf);
...
int ocall_fstat(int fd, struct stat* buf) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_fstat_args->fd, fd);
...
int ocall_fionread(int fd) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_fionread_args->fd, fd);
...
int ocall_fsetnonblock(int fd, int nonblocking) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_fsetnonblock_args->fd, fd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_fsetnonblock_args->nonblocking, nonblocking);
...
int ocall_fchmod(int fd, unsigned short mode) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_fchmod_args->fd, fd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_fchmod_args->mode, mode);
...
int ocall_fsync(int fd) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_fsync_args->fd, fd);
...
int ocall_ftruncate(int fd, uint64_t length) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_ftruncate_args->fd, fd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_ftruncate_args->length, length);
...
int ocall_mkdir(const char* pathname, unsigned short mode) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_mkdir_args->mode, mode);
    void* untrusted_pathname = sgx_copy_to_ustack(pathname, path_size);
    if (!untrusted_pathname) {
        sgx_reset_ustack(old_ustack);
        return -EPERM;
    }
    COPY_TO_UNTRUSTED_VALUE(&ocall_mkdir_args->pathname, untrusted_pathname);
...
int ocall_getdents(int fd, struct linux_dirent64* dirp, size_t dirp_size) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_getdents_args->fd, fd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_getdents_args->size, dirp_size);
    void* untrusted_dirp = sgx_alloc_on_ustack_aligned(dirp_size, alignof(*dirp));
    if (!untrusted_dirp) {
        retval = -EPERM;
        goto out;
    }
    COPY_TO_UNTRUSTED_VALUE(&ocall_getdents_args->dirp, untrusted_dirp);
...
int ocall_create_process(size_t nargs, const char** args, uintptr_t (*reserved_mem_ranges)[2],
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_cp_args->nargs, nargs);
    for (size_t i = 0; i < nargs; i++) {
        ...
        COPY_TO_UNTRUSTED_VALUE(&ocall_cp_args->args[i], unstrusted_arg);
    }
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_cp_args->reserved_mem_ranges, urts_reserved_mem_ranges);
    COPY_TO_UNTRUSTED_VALUE(&ocall_cp_args->reserved_mem_ranges_size, reserved_mem_ranges_size);
...
int ocall_futex(uint32_t* futex, int op, int val, uint64_t* timeout_us) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_futex_args->futex, futex);
    COPY_TO_UNTRUSTED_VALUE(&ocall_futex_args->op, op);
    COPY_TO_UNTRUSTED_VALUE(&ocall_futex_args->val, val);
    COPY_TO_UNTRUSTED_VALUE(&ocall_futex_args->timeout_us, timeout_us ? *timeout_us : (uint64_t)-1);
...
int ocall_socket(int family, int type, int protocol) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_socket_args->family, family);
    COPY_TO_UNTRUSTED_VALUE(&ocall_socket_args->type, type);
    COPY_TO_UNTRUSTED_VALUE(&ocall_socket_args->protocol, protocol);
...
int ocall_bind(int fd, struct sockaddr_storage* addr, size_t addrlen, uint16_t* out_new_port) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_bind_args->fd, fd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_bind_args->addrlen, addrlen);
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_bind_args->addr, untrusted_addr);
...
int ocall_listen_simple(int fd, unsigned int backlog) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_listen_args->fd, fd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_listen_args->backlog, backlog);
...
int ocall_listen(int domain, int type, int protocol, int ipv6_v6only, struct sockaddr* addr,
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_listen_args->domain, domain);
    COPY_TO_UNTRUSTED_VALUE(&ocall_listen_args->type, type);
    COPY_TO_UNTRUSTED_VALUE(&ocall_listen_args->protocol, protocol);
    COPY_TO_UNTRUSTED_VALUE(&ocall_listen_args->ipv6_v6only, ipv6_v6only);
    COPY_TO_UNTRUSTED_VALUE(&ocall_listen_args->addrlen, len);
    void* untrusted_addr = (addr && len) ? sgx_copy_to_ustack(addr, len) : NULL;
    if (addr && len && !untrusted_addr) {
        sgx_reset_ustack(old_ustack);
        return -EPERM;
    }
    COPY_TO_UNTRUSTED_VALUE(&ocall_listen_args->addr, untrusted_addr);
...
int ocall_accept(int sockfd, struct sockaddr* addr, size_t* addrlen, struct sockaddr* local_addr,
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_accept_args->sockfd, sockfd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_accept_args->addrlen, len);
    COPY_TO_UNTRUSTED_VALUE(&ocall_accept_args->local_addrlen, local_len);
    void* untrusted_addr = (addr && len) ? sgx_copy_to_ustack(addr, len) : NULL;
    if (addr && len && !untrusted_addr) {
        sgx_reset_ustack(old_ustack);
        return -EPERM;
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_accept_args->addr, untrusted_addr);
    COPY_TO_UNTRUSTED_VALUE(&ocall_accept_args->local_addr, untrusted_local_addr);
    COPY_TO_UNTRUSTED_VALUE(&ocall_accept_args->options, options);
...
int ocall_connect(int domain, int type, int protocol, int ipv6_v6only, const struct sockaddr* addr,
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_connect_args->domain, domain);
    COPY_TO_UNTRUSTED_VALUE(&ocall_connect_args->type, type);
    COPY_TO_UNTRUSTED_VALUE(&ocall_connect_args->protocol, protocol);
    COPY_TO_UNTRUSTED_VALUE(&ocall_connect_args->ipv6_v6only, ipv6_v6only);
    COPY_TO_UNTRUSTED_VALUE(&ocall_connect_args->addrlen, addrlen);
    COPY_TO_UNTRUSTED_VALUE(&ocall_connect_args->bind_addrlen, bind_len);
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_connect_args->addr, untrusted_addr);
    COPY_TO_UNTRUSTED_VALUE(&ocall_connect_args->bind_addr, untrusted_bind_addr);
...
int ocall_connect_simple(int fd, struct sockaddr_storage* addr, size_t* addrlen) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_connect_args->fd, fd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_connect_args->addrlen, *addrlen);
...
ssize_t ocall_recv(int sockfd, struct iovec* iov, size_t iov_len, void* addr, size_t* addrlenptr,
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_recv_args->sockfd, sockfd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_recv_args->count, size);
    COPY_TO_UNTRUSTED_VALUE(&ocall_recv_args->addrlen, addrlen);
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_recv_args->buf, obuf);
    COPY_TO_UNTRUSTED_VALUE(&ocall_recv_args->addr, untrusted_addr);
    COPY_TO_UNTRUSTED_VALUE(&ocall_recv_args->control, untrusted_control);
    COPY_TO_UNTRUSTED_VALUE(&ocall_recv_args->controllen, controllen);
    COPY_TO_UNTRUSTED_VALUE(&ocall_recv_args->flags, flags);
...
ssize_t ocall_send(int sockfd, const struct iovec* iov, size_t iov_len, const void* addr,
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_send_args->sockfd, sockfd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_send_args->count, size);
    COPY_TO_UNTRUSTED_VALUE(&ocall_send_args->addrlen, addrlen);
    void* untrusted_addr = addr ? sgx_copy_to_ustack(addr, addrlen) : NULL;
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_send_args->buf, obuf);
    COPY_TO_UNTRUSTED_VALUE(&ocall_send_args->addr, untrusted_addr);
    COPY_TO_UNTRUSTED_VALUE(&ocall_send_args->control, untrusted_control);
    COPY_TO_UNTRUSTED_VALUE(&ocall_send_args->controllen, controllen);
    COPY_TO_UNTRUSTED_VALUE(&ocall_send_args->flags, flags);
...
int ocall_setsockopt(int sockfd, int level, int optname, const void* optval, size_t optlen) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_setsockopt_args->sockfd, sockfd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_setsockopt_args->level, level);
    COPY_TO_UNTRUSTED_VALUE(&ocall_setsockopt_args->optname, optname);
    COPY_TO_UNTRUSTED_VALUE(&ocall_setsockopt_args->optlen, 0);
    COPY_TO_UNTRUSTED_VALUE(&ocall_setsockopt_args->optval, NULL);

    if (optval && optlen > 0) {
        COPY_TO_UNTRUSTED_VALUE(&ocall_setsockopt_args->optlen, optlen);
        void* untrusted_optval = sgx_copy_to_ustack(optval, optlen);
        if (!untrusted_optval) {
            sgx_reset_ustack(old_ustack);
            return -EPERM;
        }
        COPY_TO_UNTRUSTED_VALUE(&ocall_setsockopt_args->optval, untrusted_optval);
    }
...
int ocall_shutdown(int sockfd, int how) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_shutdown_args->sockfd, sockfd);
    COPY_TO_UNTRUSTED_VALUE(&ocall_shutdown_args->how, how);
...
int ocall_poll(struct pollfd* fds, size_t nfds, uint64_t* timeout_us) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_poll_args->nfds, nfds);
    COPY_TO_UNTRUSTED_VALUE(&ocall_poll_args->timeout_us, remaining_time_us);
    void* untrusted_fds = sgx_copy_to_ustack(fds, nfds_bytes);
    if (!untrusted_fds) {
        retval = -EPERM;
        goto out;
    }
    COPY_TO_UNTRUSTED_VALUE(&ocall_poll_args->fds, untrusted_fds);
...
int ocall_rename(const char* oldpath, const char* newpath) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_rename_args->oldpath, untrusted_oldpath);
    COPY_TO_UNTRUSTED_VALUE(&ocall_rename_args->newpath, untrusted_newpath);
...
int ocall_delete(const char* pathname) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_delete_args->pathname, untrusted_pathname);
...
int ocall_debug_map_add(const char* name, void* addr) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_debug_map_args->name, untrusted_name);
    COPY_TO_UNTRUSTED_VALUE(&ocall_debug_map_args->addr, addr);
...
int ocall_debug_describe_location(uintptr_t addr, char* buf, size_t buf_size) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_debug_describe_args->addr, addr);
    COPY_TO_UNTRUSTED_VALUE(&ocall_debug_describe_args->buf, untrusted_buf);
    COPY_TO_UNTRUSTED_VALUE(&ocall_debug_describe_args->buf_size, buf_size);
...
int ocall_eventfd(int flags) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_eventfd_args->flags, flags);
...
int ocall_get_quote(const sgx_spid_t* spid, bool linkable, const sgx_report_t* report,
    ...
    if (spid) {
        COPY_TO_UNTRUSTED_VALUE(&ocall_quote_args->is_epid, true);
        memcpy(&ocall_quote_args->spid, spid, sizeof(*spid));
    } else {
        COPY_TO_UNTRUSTED_VALUE(&ocall_quote_args->is_epid, false);
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_quote_args->linkable, linkable);
...
int ocall_sched_setaffinity(void* tcs, unsigned long* cpu_mask, size_t cpu_mask_len) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_sched_args->tcs, tcs);
    COPY_TO_UNTRUSTED_VALUE(&ocall_sched_args->cpumask_size, cpu_mask_size);
    void* untrusted_cpu_mask = sgx_copy_to_ustack(cpu_mask, cpu_mask_size);
    if (!untrusted_cpu_mask) {
        sgx_reset_ustack(old_ustack);
        return -EPERM;
    }
    COPY_TO_UNTRUSTED_VALUE(&ocall_sched_args->cpu_mask, untrusted_cpu_mask);
...
int ocall_edmm_restrict_pages_perm(uint64_t addr, size_t count, uint64_t prot) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_args->addr, addr);
    COPY_TO_UNTRUSTED_VALUE(&ocall_args->count, count);
    COPY_TO_UNTRUSTED_VALUE(&ocall_args->prot, prot);
...
int ocall_edmm_modify_pages_type(uint64_t addr, size_t count, uint64_t type) {
    ...
    COPY_TO_UNTRUSTED_VALUE(&ocall_args->addr, addr);
    COPY_TO_UNTRUSTED_VALUE(&ocall_args->count, count);
    COPY_TO_UNTRUSTED_VALUE(&ocall_args->type, type);
