...
const struct generated_offset generated_offsets[] = {
    ...
    OFFSET_T(SGX_ARCH_ENCLAVE_CSS_ISV_EXT_PROD_ID, sgx_arch_enclave_css_t, body.isv_ext_prod_id),
    ...
    OFFSET_T(SGX_ARCH_ENCLAVE_CSS_ISV_EXT_PRODID, sgx_arch_enclave_css_t, body.isv_ext_prod_id),
    OFFSET_T(SGX_ARCH_ENCLAVE_CSS_ISV_FAMILY_ID, sgx_arch_enclave_css_t, body.isv_family_id),
