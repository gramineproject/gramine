...
void _PalExceptionHandler(uint32_t trusted_exit_info_,
    ...
    if (!trusted_exit_info.valid) {
        ...
        if (untrusted_external_event != PAL_EVENT_QUIT
            ...
            if (untrusted_external_event == PAL_EVENT_MEMFAULT
                    && g_pal_linuxsgx_state.memfaults_wo_exinfo_allowed) {
                /*
                 ...
                 *
                 * This is enabled via an (insecure) manifest option and will be removed in v1.8.
                 */
    ...
    switch (event_num) {
        ...
        case PAL_EVENT_MEMFAULT:
            if (!has_hw_fault_address && !g_pal_linuxsgx_state.memfaults_wo_exinfo_allowed) {
