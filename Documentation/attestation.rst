...
specification, and is deprecated. One can see that the this old X.509
certificate format directly embeds the SGX quote, doesn't have the concept of
claims and doesn't use the CBOR data format.
