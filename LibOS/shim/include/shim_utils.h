...
int check_and_load_exec(struct shim_handle** file, const char* path, const char** argv, const char*** out_new_argv);
int check_and_load_shebang(struct shim_handle* file, const char** out_interp_path, size_t interp_path_size, const char** argv, const char*** out_new_argv);
