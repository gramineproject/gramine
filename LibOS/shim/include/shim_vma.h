 ...
 * [`g_pal_public_state->user_address.start`, `g_pal_public_state->user_address.end`). */
...
/* First tries to bookkeep in the range [`g_pal_public_state->user_address.start`, `aslr_addr_top`)
